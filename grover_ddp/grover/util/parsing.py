...
def add_finetune_args(parser: ArgumentParser):
    ...
    parser.add_argument('--torchddp', action='store_true', default=False, help='Distributing model using pytorch ddp')
    ...
    parser.add_argument('-n','--num_procs', default=2, type=int, help="the number of processes for distributed training")
